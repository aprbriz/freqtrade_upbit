...
프로젝트: Upbit Real-time OHLCV Collector
버전: v1.0
생성일: 2026-01-26
최종 업데이트: 2026-01-26
...
- timeframe_ms (INTEGER): 500, 1000, -3 등
...
업비트 KRW 마켓 실시간 체결 데이터 수집
다중 타임프레임 OHLCV 생성 (ms 단위, 틱 단위)
SQLite DB 저장 및 관리
...
[ ] CPU 사용률 < 10% (유휴 시)
[ ] 메모리 사용량 < 500MB (24시간 기준)
[ ] DB 파일 크기: 1일 약 100MB 이하
...
BL-012: 백테스팅 엔진
BL-013: freqtrade Strategy 샘플
BL-014: 실시간 알림 (Telegram, Slack)
BL-015: 다중 거래소 지원 (추상화)
