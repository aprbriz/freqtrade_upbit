    ...
    while True:
        try:
            ...
            if not i % 100:
                ...
                print(exchange.iso8601(now), n, symbol, i, orderbook['datetime'], orderbook['asks'][0], orderbook['bids'][0])
                print(exchange.iso8601(now), n, symbol, i, orderbook['asks'][1], orderbook['bids'][1])
            i += 1
